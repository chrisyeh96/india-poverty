##############INDIA ##################
# This is the script for plotting true expenditure (z-score) heatmap of India validation dataset
...
fldcons <- with(df, interp(x = longitude, y = latitude, z = true,duplicate = "strip"))
